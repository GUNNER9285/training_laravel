    ...
    <div class="card border-dark">
          ...
          <div class="card-body text-dark">
              <div class="form-group">
                ...
                <input class="form-control" id="email" name="email" type="email" value="{{ old('email') ? old('email') : $item->email }}" aria-describedby="emailHelp" placeholder="Enter email" readonly="true">
